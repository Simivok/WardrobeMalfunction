...
use App\Http\Controllers\Models\Brand;
...
Route::delete('/cart/remove-coupon',[CartController::class,'remove_coupon_code'])->name('cart.coupon.code');
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::get('/user/change-email', [UserController::class, 'editEmail'])->name('email.edit');
    Route::post('/email/update', [UserController::class, 'updateEmail'])->name('email.update');
