...
<head>
  ...
  <meta name="author" content="Waldrobe Malfuction" />
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" height="50" alt="" src="{{ asset('images/logo/logo.png')}}"
                                ...
                                <form class="form-search flex-grow">
                                    <fieldset class="name">
                                        <input type="text" placeholder="Search here..." class="show-search" name="name"
                                            tabindex="2" value="" aria-required="true" id="search-input" required="" autocomplete="off">
                                    </fieldset>
